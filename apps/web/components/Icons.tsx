/** Inline brand marks. currentColor so they follow the theme; decorative, so
 *  the accessible name comes from the surrounding link text. */
...
export function GlobeIcon() {
  return (
    <svg {...P} fill="none" stroke="currentColor" strokeWidth="1.6">
      ...
      <path d="M2.5 12h19M12 2.5c2.6 2.7 3.9 6 3.9 9.5s-1.3 6.8-3.9 9.5c-2.6-2.7-3.9-6-3.9-9.5S9.4 5.2 12 2.5z" />
    </svg>
  );
}
